...
$THEME->sheets = array('custom','blocks','menu','course','animate','settings','newstyle',);
...
$THEME->csspostprocess = 'theme_marble_process_css';
$THEME->javascripts = array('jquery.bxslider.min','jquery.appear','jquery.stellar.min','waypoint.min','custom');
